...
//       if (_personModels[i].x.abs() > projectionMaxValue)
//         projectionMaxValue = _personModels[i].x.abs();
//       if (_personModels[i].y.abs() > projectionMaxValue)
//         projectionMaxValue = _personModels[i].y.abs();
//     }
