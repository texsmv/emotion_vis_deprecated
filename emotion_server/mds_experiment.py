...
for file in files:
    ...
    dataset.add(mtserie, mtserie.getMetadata("id"))

# query = dataset.queryAllByIndex(0, 5, toList=True)
...
Mnum = dataset.getNumericalValues()

Mcat = dataset.getCategoricalValues()
